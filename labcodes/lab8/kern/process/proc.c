...
alloc_proc(void) {
    ...
    memset(proc->name, 0, sizeof(char) * (PROC_NAME_LEN + 1));
     ...
     //LAB5 2016012205 : (update LAB4 steps)
    /*
    ...
    proc->optr = proc->yptr = proc->cptr = NULL;
     ...
     //LAB6 2016012205 : (update LAB5 steps)
    /*
    ...
    //LAB8:EXERCISE2 2016012205 HINT:need add some code to init fs in proc_struct, ...
    proc->filesp = NULL;
    }
    return proc;
}
...
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
    ...
    ret = -E_NO_MEM;
    //LAB4:EXERCISE2 2016012205
    //LAB8:EXERCISE2 2016012205  HINT:how to copy the fs in parent's proc_struct?
    /*
...
load_icode(int fd, int argc, char **kargv) {
    /* LAB8:EXERCISE2 2016012205  HINT:how to load the file with handler fd  in to process's memory? how to setup argc/argv?
     * MACROs or Functions:
